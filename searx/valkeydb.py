...
try:
    import pwd  # Unix-only; absent on Windows. Used solely for an error-log message.
except ImportError:
    pwd = None  # absent on Windows
...
def initialize():
    ...
    try:
        ...
        if pwd is not None and hasattr(os, "getuid"):
            ...
            logger.exception("[pid %s] can't connect valkey DB ...", os.getpid())
    return False
